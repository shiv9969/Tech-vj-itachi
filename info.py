...
auth_channel = environ.get('AUTH_CHANNEL', '-1002077157127 -1002289259768') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Shivji:BoBfiles@cluster0.t1mka5v.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Shiv")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Itachi')
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://romantic-tarantula-bob-bots-de0b56ac.koyeb.app/")
